...
from ...parity.fixtures.store import fixture_id
...
def pytest_generate_tests(metafunc: pytest.Metafunc) -> None:
    parametrize_recorded_fixtures(
        ...
        regeneration_command=(
            f"uv run python -m tests.rust-python-harness.e2e_fuzz_tests.ocr.fixtures.record --fixture-dir {DEFAULT_FIXTURE_DIRECTORY}"
        ),
