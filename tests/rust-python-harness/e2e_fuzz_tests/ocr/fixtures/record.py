...
from ....parity.fixtures.media import structured_image_data_uri
from ....parity.fixtures.pipeline import record_fixtures
from ....parity.fixtures.store import fixture_directory
from .azure import (
