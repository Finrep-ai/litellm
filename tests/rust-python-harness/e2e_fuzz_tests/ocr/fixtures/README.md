...
```shell
uv run python -m tests.rust-python-harness.e2e_fuzz_tests.ocr.fixtures.record --examples 4 --concurrency 4
```
...
```shell
uv run python -m tests.rust-python-harness.e2e_fuzz_tests.ocr.fixtures.migrate --fixture-dir tests/rust-python-harness/e2e_fuzz_tests/ocr/fixtures/data
```
